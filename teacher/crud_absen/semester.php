					 ...
					 <?php
                        ...
                        echo "";
 						...
 						while($user_data = mysqli_fetch_array($result)) {         
							 ...
							 echo "<td><a class='btn btn-success' href='mapel.php?ID_SEMESTER=$user_data[ID_SEMESTER]&CRUD=1'>Masukkan Absen</a></td>";
							 

							 echo "<td><a class='btn btn-success' href='mapel.php?ID_SEMESTER=$user_data[ID_SEMESTER]&CRUD=0'>Lihat Absen</a></td></tr>";
