...
<body>
	<section class="sidebar close">
		...
		<ul class="list-menu">
			...
			<li>
				<a href="crud_semester.php"><i class="fas fa-address-book"></i><p>Daftar Semester</p></a>
				<ul class="sub-menu hint">
	...
	<section class="home">
		...
		<div class="content">
			...
			<div class="container mx-auto my-3 mx-2" >
        		<a class="btn btn-success btn-lg " href="add.php">Tambah Semester</a><br/><br/>
					...
					<tr>
					 ...
					 <?php  
 						while($user_data = mysqli_fetch_array($result)) {         
							 ...
							 if($user_data['MEMBAGI_RAPORT']==1){
								echo "<td>Ya</td>";
							 }else{
								echo "<td>Tidak</td>";
							 }
							    
							 echo "<td><a class='btn btn-success' href='edit.php?ID_SEMESTER=$user_data[ID_SEMESTER]'>Edit</a> | <a class='btn btn-danger' href='delete.php?ID_SEMESTER=$user_data[ID_SEMESTER]'>Delete</a></td></tr>";        
 						}
 					?>
        		    </table>
        		</div>
